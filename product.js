const produtos = [
{id:1,name:'NIKE Air jordan', price:2200, src:'shoes2/nike/jd_763546_b.webp'},
{id:2,name:'NIKE Air max', price:1999, src:'shoes2/nike/jd_763831_b.webp'},
{id:3,name:'NIKE Retro 4', price:2200, src:'shoes2/nike/jd_764400_b.webp'},
{id:4,name:'NIKE Jordan MVP', price:2200, src:'shoes2/nike/jd_764404_b.webp'},
 {id:5,name:'NIKE Jordan MVP', price:2200, src:'shoes2/nike/jd_764405_b.webp'},
{id:6,name:'NIKE Air jordan 1', price:2200, src:'shoes2/nike/jd_765172_b.webp'},
{id:7,name:'NIKE Air jordan 1', price:2200, src:'shoes2/nike/jd_765173_b.webp'},
{id:8,name:'NIKE Air force 1', price:2100, src:'shoes2/nike/jd_772995_b.webp'},
{id:9,name:'NIKE Air jordan', price:2200, src:'shoes2/nike/jd_773071_b.webp'},
 {id:10,name:'NIKE Air force 1', price:2100, src:'shoes2/nike/jdpt_product_list (9).webp'},
{id:11,name:'NIKE Air force', price:2100, src:'shoes2/nike/jdpt_product_list (13).webp'},
{id:12,name:'NIKE Air force', price:2100, src:'shoes2/nike/jdpt_product_list (14).webp'},
{id:13,name:'NIKE Jordan 4 RM', price:2100, src:'shoes2/nike/jdpt_product_list.webp'},
{id:14,name:' NIKE SB Dunk', price:2200, src:'shoes2/nike/m45022151126_1.jpg'},
{id:15,name:'NIKE Air MAX', price:2200, src:'shoes2/nike/41hxrUprBwL._SL500.jpg'},
{id:16,name:'NIKE SB Dunk', price:2200, src:'shoes2/nike/7144310582.jpg'},
{id:17,name:'NIKE Air Max', price:2200, src:'shoes2/nike/2024120214290719-175.webp'},
{id:18,name:'NIKE Retro 4', price:2200, src:'shoes2/nike/CT8527-700_2.webp'},
  {id:19,name:'ADIDAS Campus', price:2200, src:'shoes2/Adidas/jdpt_product_list (9).webp'},
    {id:20,name:'ADIDAS Campus', price:2200, src:'shoes2/Adidas/jdpt_product_list (10).webp'},
    {id:21,name:'ADIDAS Galaxy OG', price:2100, src:'shoes2/Adidas/jdpt_product_list (11).webp'},
    {id:22,name:'ADIDAS Superstar', price:2200, src:'shoes2/Adidas/jdpt_product_list (12).webp'},
    {id:23,name:'ADIDAS Campus', price:2200, src:'shoes2/Adidas/jdpt_product_list (13).webp'},
    {id:24,name:'ADIDAS Superstar', price:2200, src:'shoes2/Adidas/jdpt_product_list (14).webp'},
    {id:25,name:'ADIDAS Spezial', price:2100, src:'shoes2/Adidas/jdpt_product_list (15).webp'},
    {id:26,name:'ADIDAS Superstar', price:2200, src:'shoes2/Adidas/jdpt_product_list (16).webp'},
   {id:27, name:'ADIDAS Campus', price:2200, src:'shoes2/Adidas/jdpt_product_list (17).webp'},
{id:28, name:'ADIDAS Campus', price:2200, src:'shoes2/Adidas/jdpt_product_list (18).webp'},
    {id:29,name:'ADIDAS Campus', price:2200, src:'shoes2/Adidas/jdpt_product_list (19).webp'},
    {id:30,name:'ADIDAS Campus', price:2200, src:'shoes2/Adidas/jdpt_product_list (20).webp'},
 {id:31,name:'PUMA Palermo', price:2180, src:'shoes2/PUMA/jdpt_product_list (29).webp'},
    {id:32,name:'PUMA Leopard arizona', price:2099, src:'shoes2/PUMA/jdpt_product_list (30).webp'},
    {id:33,name:'PUMA Speedcat', price:2180, src:'shoes2/PUMA/jdpt_product_list (31).webp'},
    {id:34,name:'PUMA Palermo', price:2180, src:'shoes2/PUMA/jdpt_product_list (32).webp'},
    {id:35,name:'PUMA Speedcat', price:2180, src:'shoes2/PUMA/jdpt_product_list (33).webp'},
    {id:36,name:'PUMA Speedcat', price:2180, src:'shoes2/PUMA/jdpt_product_list (34).webp'},
    {id:37,name:'PUMA Suede', price:2180, src:'shoes2/PUMA/Suede-XL-Sneakers (1).avif'},
    {id:38,name:'PUMA Suede', price:2180, src:'shoes2/PUMA/suede red.jpg'},
    {id:39,name:'PUMA Suede', price:2180, src:'shoes2/PUMA/Suede-XL-Sneakers white.avif'},
{id:40,name:'NIKE SB Dunk', price:2200, src:'shoes2/nike/e7481f47ca3bb879d48c258387cf9ba3.jpg'},
{id:41,name:'NIKE Air Jordan 1', price:2200, src:'shoes2/nike/becce9fc6575f718269f41e4435e4201.jpg'},
  {id:42, name:'NEW BALANCE', price:2200, src:'shoes2/Adidas/jdpt_product_list (35).webp'},
  {id:43, name:'NEW BALANCE', price:2200, src:'shoes2/Adidas/jdpt_product_list (36).webp'},
  {id:44, name:'NEW BALANCE', price:2200, src:'shoes2/Adidas/jdpt_product_list (37).webp'},
  {id:45, name:'REEBOOK', price:2200, src:'shoes2/Adidas/jdpt_product_list (38).webp'},
  {id:46, name:'REEBOOK', price:2200, src:'shoes2/Adidas/jdpt_product_list (39).webp'},
  {id:47, name:'REEBOOK', price:2200, src:'shoes2/Adidas/jdpt_product_list (40).webp'},
  {id:48, name:'ALL STAR', price:2200, src:'shoes2/Adidas/jdpt_product_list (41).webp'},
  {id:49, name:'ALL STAR', price:2200, src:'shoes2/Adidas/jdpt_product_list (42).webp'},
  {id:50, name:'ALL STAR', price:2200, src:'shoes2/Adidas/jdpt_product_list (43).webp'},
  {id:52, name:'NIKE SB Dunk', price:2200, src:'shoes2/nike/7144310582.jpg'},
  {id:53,name:'NIKE Air jordan 1', price:2200, src:'shoes2/nike/jd_765172_b.webp'},
   {id:54,name:'NIKE Air jordan 1', price:2200, src:'shoes2/nike/jd_765173_b.webp'},
    {id:55,name:'NIKE Air force 1', price:2100, src:'shoes2/nike/jd_772995_b.webp'},
   {id:56, name:'NIKE Air MAX', price:2200, src:'shoes2/nike/tenis-esportivo-nike-feminino-air-max-portal-hf3053-011-cinza-hf3053-011-6-.webp'},
];
...
const Adidas = [
    ...
    {name:'ADIDAS Campus', price:2200, src:'shoes2/Adidas/jd_619586_b.webp'},
     {name:'ADIDAS Samba', price:2100, src:'shoes2/Adidas/Samba_XLG_Shoes_Black_IE1379_04_standard.avif'},
    ...
    {name:'ADIDAS Campus', price:2100, src:'shoes2/Adidas/jdpt_product_list (6).webp'},
      {name:'ADIDAS Spezial', price:2100, src:'shoes2/Adidas/spezial.jpg'},
    {name:'ADIDAS Campus', price:2200, src:'shoes2/Adidas/jdpt_product_list (7).webp'},
    {name:'ADIDAS Samba', price:2100, src:'shoes2/Adidas/Samba_OG_Shoes_White_ID0478_01_standard.jpg'},
    ...
    {name:'ADIDAS Galaxy OG', price:2100, src:'shoes2/Adidas/jdpt_product_list (11).webp'},
     {name:'ADIDAS Spezial', price:2100, src:'shoes2/Adidas/Handball_Spezial_Shoes_Blue_IF7087_15_hover_standard.avif'},
    ...
    {name:'ADIDAS Campus', price:2200, src:'shoes2/Adidas/jdpt_product_list (18).webp'},
     {name:'ADIDAS Superstar', price:2200, src:'shoes2/Adidas/Superstar_ADV_Shoes_White_IE0669_04_standard c.avif'},
      {name:'ADIDAS Superstar', price:2200, src:'shoes2/Adidas/Superstar_II_Shoes_Black_JI3538_04_standard.avif'},
       {name:'ADIDAS Superstar', price:2200, src:'shoes2/Adidas/Superstar_II_Shoes_White_JI0080_04_standard.avif'},
    ...
    {name:'ADIDAS Campus', price:2200, src:'shoes2/Adidas/jdpt_product_list (22).webp'},
      {name:'ADIDAS Spezial', price:2100, src:'shoes2/Adidas/Handball_Spezial_Shoes_Black_DB3021_00_plp_standard.avif'},
...
{name:'PUMA Speedcat', price:2180, src:'shoes2/Adidas/jdpt_product_list (26).webp'},
    ...
    {name:'PUMA Speedcat', price:2180, src:'shoes2/PUMA/jdpt_product_list (31).webp'},
     {name:'PUMA Suede', price:2180, src:'shoes2/PUMA/verdao.jpg'},
